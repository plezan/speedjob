...
export default {
  ...
  methods: {
    ...
    brouillon: function(brouillon){
      //axios.post brouillon, changement de la valeur de offe_status pour enregistrer comme brouillon ? 
       axios.post('/user', {
         newOffer,
         offe_status: 2, 
      })
